...
APP_RUNTIME := src/app/daemon.c src/template.c src/app/tasks.c
APP_HEADERS := src/app/tasks.h build/app_tasks.h src/app/daemon.h clients/geistd_client.h src/jsmn.h src/template.h src/json.h
.PHONY: app test-app
app: geist-app
...
test-app: geist-app build/test_app_core build/test_app_client build/test_app_tasks
	./build/test_app_core
